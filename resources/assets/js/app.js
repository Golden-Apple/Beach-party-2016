	...
	render() {
		return (
			<GoogleMapLoader
				...
				googleMapElement={
					<GoogleMap containerProps={this.props} defaultZoom={16} defaultCenter={{ lat: 26.222145, lng: 127.667405 }} defaultOptions={{styles: require(`../json/MapStyle.json`),}}>
						{this.state.directions ? <DirectionsRenderer directions={this.state.directions} /> : null}

						<Marker defaultPosition={{ lat: 26.220253, lng: 127.664808 }} defaultIcon={'/assets/image/item-sisa.png'} >
